export const translations = {
  en: {
    ...
    hero: {
      eyebrow: "Brand Identity Designer",
      title: "Designing brands people remember.",
      mobileTitle: ["Designing", "brands", "people", "remember."],
      description:
        "I create strategic brand identities, print design and visual communication for cafés, restaurants, gyms and ambitious businesses that want to stand out.",
      mobileDescription:
    ...
    about: {
      ...
      title: "Hi, I\u0027m Mátyás.",
      description:
        "I\u0027m a graphic designer from Hungary specializing in brand identity, print design and visual communication. I enjoy creating clean, timeless design that helps businesses grow.",
      stats: {
        projects: "Projects",
        years: "Years",
        custom: "Custom",
