  ...
  return (
    <main className="min-h-screen bg-[#F8F9FB]">
      ...
      <section className="mx-auto max-w-[1600px] px-8 pt-44 lg:px-24">
        ...
        <h1 className="mt-6 text-6xl font-bold leading-none tracking-[-0.05em] text-[var(--primary)] md:text-7xl xl:text-8xl">
          {project.title}
        </h1>
        ...
        <div className="mt-28 grid gap-16 lg:grid-cols-[220px_1fr]">
          ...
          <div className="flex flex-wrap gap-4">
            {project.services.map((service) => (
              <span
                key={service}
                className="rounded-full bg-white px-6 py-3 font-medium shadow-sm"
              >
                {service}
              </span>
            ))}
