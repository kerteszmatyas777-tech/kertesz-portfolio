    ...
    >
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-3">
        {t.services.items.map((service) => (
          <article
            key={service.title}
            className="group relative min-h-[20rem] overflow-hidden rounded-[28px] border border-[var(--primary)]/10 bg-white p-8 transition-all duration-500 hover:-translate-y-1 hover:border-[var(--primary)]/25 hover:shadow-2xl md:p-10"
          >
            <div
              aria-hidden="true"
            ...
            <div className="relative flex h-full flex-col">
              <h3 className="mt-8 max-w-[16rem] text-[2rem] font-bold leading-[0.98] tracking-[-0.04em] text-[var(--primary)] transition-transform duration-500 group-hover:translate-x-1">
                {service.title}
              </h3>
